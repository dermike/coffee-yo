...
function CoffeeYo(t){this.options={append:"#yo",buttonText:"Coffee is ready!",buttonWaitText:"Sending...",buttonSentText:"Sent!"},this.options=t,self=this,this.insertButton()}CoffeeYo.prototype.insertButton=function(){var t='<button id="yobutton" class="button expand">'+this.options.buttonText+"</button>";$(this.options.append).append(t),$('<div id="status"></div>').insertAfter("#yobutton"),$("#yobutton").click(function(){self.send()})},CoffeeYo.prototype.buttonState=function(t){switch(t){case"sending":$("#yobutton").attr("disabled","disabled").html(this.options.buttonWaitText);break;case"success":$("#yobutton").addClass("sent").html(this.options.buttonSentText);break;case"normal":$("#yobutton").removeAttr("disabled").html(this.options.buttonText)}},CoffeeYo.prototype.send=function(){this.buttonState("sending"),$.ajax({type:"GET",url:"yo.php",dataType:"json",contentType:"application/json",success:function(t){t.error?($("#status").html("Error: "+t.error),self.buttonState("normal")):"OK"===t.result?self.buttonState("success"):($("#status").html("Unknown error"),self.buttonState("normal"))},error:function(t){$("#status").html("Error: "+t.statusText),self.buttonState("normal")}})};var yo=new CoffeeYo({append:"#yo",buttonText:"Kaffet &auml;r klart!",buttonWaitText:"Skickar...",buttonSentText:"Skickat!"});